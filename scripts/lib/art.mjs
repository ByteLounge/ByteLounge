  ...
  return `
    <g transform="translate(${x}, ${y})">
      <g class="lofi-player fade d12">
        <!-- Player pill frame -->
        <rect x="0" y="0" width="380" height="32" rx="16" fill="${pillBg}" stroke="${pillBorder}" stroke-width="1" />
      
        <!-- Cassette / Headphone Pulse Icon -->
        <g transform="translate(13, 8) scale(0.66)">
        ...
        <!-- Animated Audio Waveform in front of NOW PLAYING -->
        <g class="eq-bars" transform="translate(36, 10)">
          <rect x="0" y="0" width="2.5" height="12" rx="1.25" fill="${accentColor}" class="eq-bar b1" />
          <rect x="4.5" y="0" width="2.5" height="12" rx="1.25" fill="#f6ad55" class="eq-bar b2" />
          <rect x="9" y="0" width="2.5" height="12" rx="1.25" fill="#f687b3" class="eq-bar b3" />
          <rect x="13.5" y="0" width="2.5" height="12" rx="1.25" fill="#68d391" class="eq-bar b4" />
          <rect x="18" y="0" width="2.5" height="12" rx="1.25" fill="${accentColor}" class="eq-bar b5" />
        </g>

        <!-- NOW PLAYING Text -->
        <text x="66" y="20.5" font-family="'Space Grotesk', -apple-system, sans-serif" font-size="10.5" font-weight="700" fill="${textColor}" letter-spacing="0.3">
          NOW PLAYING:
        </text>

        <!-- Track Title -->
        <text x="146" y="20" font-family="ui-monospace, SFMono-Regular, monospace" font-size="10" font-weight="400" fill="${theme.muted}">
...
/**
 * Animated Cat that walks across the page, taps the contribution map,
 * and highlights total contributions!
 */
        ...
        <g class="cat-facer">
          ...
          <g class="cat-sleep-pose" transform="scale(1.15)">
            <g class="cat-breathe">
              ...
              <!-- Curled Tail (anchored deep inside body at x=15, y=13, curling to front white tip at x=22, y=18) -->
              <path d="M 15 13 Q 3 15 4 19 Q 8 22 15 21 Q 19 20 22 18" fill="none" stroke="${catColor}" stroke-width="3.2" stroke-linecap="round" />
              <!-- Tail white tip -->
              <circle cx="22" cy="18" r="1.8" fill="${catBelly}" />
            </g>
          ...
          <g class="cat-active-pose" transform="scale(1.15)">
            ...
            <!-- Tail with smooth wagging animation (nested group so translate(10, 14) is never overridden) -->
            <g transform="translate(10, 14)">
              <g class="cat-tail-group">
                <path d="M 2 0 C -4 0 -8 -3 -12 -10" stroke="${catColor}" stroke-width="3.2" fill="none" stroke-linecap="round" />
                <circle cx="-12" cy="-10" r="1.8" fill="${catBelly}" />
              </g>
            </g>
